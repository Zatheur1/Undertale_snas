...
inst.text="{font FONT.SANS}{voice VOICE.SANS}{face_link 0}{face_emotion 5}welp here goes nothing&are you ready?{face_link 0}{face_emotion 1}&Survive this and i&show you my attack";
inst.template=0;